...
const useKaitoriIphones = () => {
  ...
  const url = "/api/kaitori/iphone-prices";
  const CACHE_KEY = "kaitori_iphones_data";
  const CACHE_TIMESTAMP_KEY = "kaitori_iphones_timestamp";
...
export default useKaitoriIphones;
